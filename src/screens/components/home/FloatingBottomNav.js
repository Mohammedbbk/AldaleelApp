    ...
    <View className="absolute bottom-6 left-6 right-6 z-50">
      ...
      <View className="bg-white rounded-3xl shadow-xl py-4 px-6">
        <View className="flex-row justify-between items-center">
          ...
          >
            <View className={`p-2 rounded-full ${isActive('AIChat') ? `bg-[${activeBgColor}]` : ''}`}>
              <MessageSquareIcon size={22} color={isActive('AIChat') ? activeColor : inactiveColor} strokeWidth={1.5} />
            </View>
            <Text className={`text-xs mt-1 ${isActive('AIChat') ? `text-[${activeColor}]` : `text-[${inactiveColor}]`}`}>AI Chat</Text>
          </TouchableOpacity>
          ...
          >
            <View className={`p-2 rounded-full ${isActive('Profile') ? `bg-[${activeBgColor}]` : ''}`}>
              <UserIcon size={22} color={isActive('Profile') ? activeColor : inactiveColor} strokeWidth={1.5} />
            </View>
            <Text className={`text-xs mt-1 ${isActive('Profile') ? `text-[${activeColor}]` : `text-[${inactiveColor}]`}`}>Profile</Text>
          </TouchableOpacity>
